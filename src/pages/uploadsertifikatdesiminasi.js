...
const UploadSertifikatDesiminasi = () => {
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-2xl rounded-3xl overflow-hidden">
          <div className="px-6 py-8 sm:p-10">
            <h1 className="text-4xl font-extrabold text-purple-800 mb-8">Upload Sertifikat Diseminasi</h1>
              ...
              >
                <div className="space-y-1 text-center">
                  ...
                  <div className="flex text-sm text-gray-600 justify-center">
                    ...
                    >
                      <span className="px-2">Unggah file</span>
                      <input
                        id="file-upload"
                        name="file-upload"
                        type="file"
...
export default UploadSertifikatDesiminasi;
